...
export const SupplierDetailView = ({ supplier, onEdit, onDelete, open, onOpenChange }: SupplierDetailViewProps) => {
  ...
  const handleEditClick = () => {
    onOpenChange(false); // Close detail view first
    setIsEditOpen(true);
  };
  ...
  return (
    <>
      ...
      {/* Edit Sheet - Completely separate instance */}
